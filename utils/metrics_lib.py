...
def All_Metrics2(pred, true, *args):
    mae = masked_mae(pred, true, null_val=0.)
    rmse = masked_rmse(pred, true, null_val=0.)
    mape = masked_mape(pred, true, null_val=0.)
    return mae, rmse, mape
